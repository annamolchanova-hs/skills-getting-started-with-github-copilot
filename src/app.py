...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team soccer skills and compete in matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Work on basketball drills, teamwork, and friendly games",
    ...
    "Drama Club": {
        "description": "Rehearse plays, develop acting skills, and stage performances",
...
def unregister_from_activity(activity_name: str, participant: str):
